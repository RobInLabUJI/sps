...
def callback_laser(msg):
    ...
    section = {
        'front': min(laser_range[60:90]),
        'left': min(laser_range[0:40]),
        'right': min(laser_range[110:150]),
    }
...
def bug_action():
    ...
    b = 2  # maximum threshold distance
    a = 1.5  # minimum threshold distance
...
def check():
    ...
    rospy.Subscriber('/scan_front', LaserScan, callback_laser)
    rate = rospy.Rate(50)
